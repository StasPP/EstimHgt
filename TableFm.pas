...
type
  TRoute = record
     ...
     SPDarray : array of Double;
     DOParray : array of Double;
     NSATarray : array of Double;
  end;
...
function ReplaceZptToDot(s:string):string;
...
begin
  ...
  S.Add(SMin+ #$9 +FloatToStr(Routes[i].Larray[0]) + #$9 +  '0' + #$9 + '0' + #$9 +
          IntToStr(SpinEdit1.Value) + #$9 + ReplaceZptToDot(Routes[i].Tarray[0]));

  S.Add(SMin+ #$9 + FloatToStr(Routes[i].Larray[Length(Routes[i].Larray)-1]) + #$9 +  '0' + #$9 + '0' + #$9 +
          IntToStr(SpinEdit1.Value)+ #$9 +
          ReplaceZptToDot(Routes[i].Tarray[Length(Routes[i].Tarray)-1]));

  // HMax
  S.Add(SMax+ #$9 + FloatToStr(Routes[i].Larray[0]) + #$9 + '0' + #$9 +
          IntToStr(SpinEdit3.Value) + #$9 + IntToStr(SpinEdit2.Value)+ #$9 +
          ReplaceZptToDot(Routes[i].Tarray[0]));
  ...
  for j := 0 to Length(Routes[i].Larray)-1 do
    S.Add(SName+Routes[i].name + #$9 + FloatToStr(Routes[i].Larray[j]) + #$9 +
          ...
          ReplaceZptToDot(Routes[i].Tarray[j])+ #$9 +
          FloatToStr(Routes[i].SPDarray[j]) + #$9 +
          FloatToStr(Routes[i].DOParray[j]) + #$9 +
          FloatToStr(Routes[i].NSATarray[j])+ #$9  
  ...
  for j := 0 to Length(Routes[i].Larray)-1 do
    S.Add(Hg + #$9 + FloatToStr(Routes[i].Larray[j]) + #$9 +
          ...
          '0' +  #$9 + '0'+ #$9 +
          ReplaceZptToDot(Routes[i].Tarray[j]));
...
begin
  ...
  Begin
    ...
    Form2.Button4.Enabled := '_' = GetCols(FData[0], 16,1,1);
    Form2.Button5.Enabled := '_' = GetCols(FData[0], 16,1,1);
    Form2.Button6.Enabled := '_' = GetCols(FData[0], 16,1,1);
    Form3.C4.Enabled := '_' = GetCols(FData[0], 16,1,1);
    Form3.C5.Enabled := '_' = GetCols(FData[0], 16,1,1);
    Form3.C6.Enabled := '_' = GetCols(FData[0], 16,1,1);
  End;
...
begin
  ...
  //begin
    ...
    Begin
      ...
      SetLength(Routes[RCount-1].SPDarray,k);
      SetLength(Routes[RCount-1].DOParray,k);
      SetLength(Routes[RCount-1].NSATarray,k);

      Routes[RCount-1].t2 := GetColsS(FData[i], 0,1,1);
      ...
      Routes[RCount-1].Tarray[k-1] := GetColsS(FData[i], 13,1,1) +' '+ Routes[RCount-1].t2;

      Routes[RCount-1].NSATarray[k-1] := StrToFloat2(GetCols(FData[i], 14,1,1));
      Routes[RCount-1].DOParray[k-1]  := StrToFloat2(GetCols(FData[i], 15,1,1));
      Routes[RCount-1].SPDarray[k-1]  := StrToFloat2(GetCols(FData[i], 17,1,1));
    ...
    End
      ...
      Begin
        ...
        Routes[RCount-1].t1 := GetColsS(FData[i], 0,1,1);
        Routes[RCount-1].t2 := GetColsS(FData[i], 0,1,1);
        Routes[RCount-1].Tarray[k-1] := GetColsS(FData[i], 13,1,1) +' '+Routes[RCount-1].t2;
...
begin
   ...
   try
     ...
     Form2.Button4.Caption := s[76];
     Form2.Button5.Caption := s[77];
     Form2.Button6.Caption := s[78];

     Form3.C4.Caption := s[79];
     Form3.C5.Caption := s[80];
     Form3.C6.Caption := s[81];
   except
...
begin
  ...
  for j := 0 to Length(Routes[i].Larray)-1 do
    S.Add(SName+Routes[i].name + #$9 + FloatToStr(Routes[i].Larray[j]) + #$9 +
          ...
          FloatToStr(Routes[i].SPDarray[j])+ #$9+
          FloatToStr(Routes[i].DOParray[j])+ #$9+
          FloatToStr(Routes[i].NSATarray[j]));
